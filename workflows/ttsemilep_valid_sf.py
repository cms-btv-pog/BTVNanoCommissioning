...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        if isRealData :
            ...
            csvsfs_c_lj = getSF(ak.to_numpy(sjets[:,0].hadronFlavour),ak.to_numpy(sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB)),ak.to_numpy(sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB)),deepcsvc_sf)
            ...
            csvsfs_c_tj = getSF(ak.to_numpy(sjets[:,2].hadronFlavour),ak.to_numpy(sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB)),ak.to_numpy(sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB)),deepcsvc_sf)
            csvsfs_c_fj = getSF(ak.to_numpy(sjets[:,3].hadronFlavour),ak.to_numpy(sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB)),ak.to_numpy(sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB)),deepcsvc_sf)
            ...
            csvsfs_c_up_lj = getSF(ak.to_numpy(sjets[:,0].hadronFlavour),ak.to_numpy(sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB)),ak.to_numpy(sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB)),deepcsvc_sf,"TotalUncUp")
            ...
            csvsfs_c_up_tj = getSF(ak.to_numpy(sjets[:,2].hadronFlavour),ak.to_numpy(sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB)),ak.to_numpy(sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB)),deepcsvc_sf,"TotalUncUp")
            csvsfs_c_up_fj = getSF(ak.to_numpy(sjets[:,3].hadronFlavour),ak.to_numpy(sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB)),ak.to_numpy(sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB)),deepcsvc_sf,"TotalUncUp")
            ...
            csvsfs_c_dn_lj = getSF(ak.to_numpy(sjets[:,0].hadronFlavour),ak.to_numpy(sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB)),ak.to_numpy(sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB)),deepcsvc_sf,"TotalUncDown")
            ...
            csvsfs_c_dn_tj = getSF(ak.to_numpy(sjets[:,2].hadronFlavour),ak.to_numpy(sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB)),ak.to_numpy(sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB)),deepcsvc_sf,"TotalUncDown")
            csvsfs_c_dn_fj = getSF(ak.to_numpy(sjets[:,3].hadronFlavour),ak.to_numpy(sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB)),ak.to_numpy(sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB)),deepcsvc_sf,"TotalUncDown")
        ...
        if not isRealData:
            ...
            output['deepcsv_CvB_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvB=sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB),weight=weights.weight()[event_level])
            output['deepcsv_CvL_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvL=sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB),weight=weights.weight()[event_level])
            output['deepflav_CvB_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvB=sjets[:,0].btagDeepFlavC/(1.-sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level])
            output['deepflav_CvL_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvL=sjets[:,0].btagDeepFlavC/(sjets[:,0].btagDeepFlavC+sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level])
            ...
            output['deepcsv_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvB=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level])
            output['deepcsv_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvL=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level])
            output['deepflav_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvB=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level])
            output['deepflav_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvL=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level])
            ...
            output['deepcsv_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvB=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level])
            output['deepcsv_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvL=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level])
            output['deepflav_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvB=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level])
            output['deepflav_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvL=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level])
            ...
            output['deepcsv_CvBSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvBSF=sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_lj)
            output['deepcsv_CvLSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvLSF=sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_lj)
            output['deepflav_CvBSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvBSF=sjets[:,0].btagDeepFlavC/(1.-sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_lj)
            output['deepflav_CvLSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvLSF=sjets[:,0].btagDeepFlavC/(sjets[:,0].btagDeepFlavC+sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_lj)
            ...
            output['deepcsv_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvBSF=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_tj)
            output['deepcsv_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvLSF=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_tj)
            output['deepflav_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvBSF=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_tj)
            output['deepflav_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvLSF=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_tj)
            ...
            output['deepcsv_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvBSF=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_fj)
            output['deepcsv_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvLSF=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_fj)
            output['deepflav_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvBSF=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_fj)
            output['deepflav_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvLSF=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_fj)
            ###SFs up
            ...
            output['deepcsv_CvB_up_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvB_up=sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_lj)
            output['deepcsv_CvL_up_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvL_up=sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_lj)
            output['deepflav_CvB_up_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvB_up=sjets[:,0].btagDeepFlavC/(1.-sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_lj)
            output['deepflav_CvL_up_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvL_up=sjets[:,0].btagDeepFlavC/(sjets[:,0].btagDeepFlavC+sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_lj)
            ...
            output['deepcsv_CvB_up_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvB_up=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_tj)
            output['deepcsv_CvL_up_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvL_up=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_tj)
            output['deepflav_CvB_up_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvB_up=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_tj)
            output['deepflav_CvL_up_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvL_up=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_tj)
            ...
            output['deepcsv_CvB_up_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvB_up=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_fj)
            output['deepcsv_CvL_up_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvL_up=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_fj)
            output['deepflav_CvB_up_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvB_up=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_fj)
            output['deepflav_CvL_up_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvL_up=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_fj)            
            ###SFs down
            ...
            output['deepcsv_CvB_dn_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvB_dn=sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_lj)
            output['deepcsv_CvL_dn_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvL_dn=sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_lj)
            output['deepflav_CvB_dn_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvB_dn=sjets[:,0].btagDeepFlavC/(1.-sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_lj)
            output['deepflav_CvL_dn_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvL_dn=sjets[:,0].btagDeepFlavC/(sjets[:,0].btagDeepFlavC+sjets[:,0].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_lj)
            ...
            output['deepcsv_CvB_dn_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvB_dn=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_tj)
            output['deepcsv_CvL_dn_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvL_dn=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_tj)
            output['deepflav_CvB_dn_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvB_dn=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_tj)
            output['deepflav_CvL_dn_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvL_dn=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_tj)
            ...
            output['deepcsv_CvB_dn_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvB_dn=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_fj)
            output['deepcsv_CvL_dn_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvL_dn=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_fj)
            output['deepflav_CvB_dn_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvB_dn=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_fj)
            output['deepflav_CvL_dn_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvL_dn=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_fj)
        else:
            ...
            output['deepcsv_CvB_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvB=sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB))
            output['deepcsv_CvL_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvL=sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB))
            output['deepflav_CvB_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvB=sjets[:,0].btagDeepFlavC/(1.-sjets[:,0].btagDeepFlavB))
            output['deepflav_CvL_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvL=sjets[:,0].btagDeepFlavC/(sjets[:,0].btagDeepFlavC+sjets[:,0].btagDeepFlavB))
            ...
            output['deepcsv_CvB_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepcsv_CvB=sjets[:,1].btagDeepC/(1.-sjets[:,1].btagDeepB))
            output['deepcsv_CvL_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepcsv_CvL=sjets[:,1].btagDeepC/(sjets[:,1].btagDeepC+sjets[:,1].btagDeepB))
            output['deepflav_CvB_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepflav_CvB=sjets[:,1].btagDeepFlavC/(1.-sjets[:,1].btagDeepFlavB))
            output['deepflav_CvL_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepflav_CvL=sjets[:,1].btagDeepFlavC/(sjets[:,1].btagDeepFlavC+sjets[:,1].btagDeepFlavB))
            ...
            output['deepcsv_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvB=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB))
            output['deepcsv_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvL=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB))
            output['deepflav_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvB=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB))
            output['deepflav_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvL=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB))
            ...
            output['deepcsv_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvB=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB))
            output['deepcsv_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvL=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB))
            output['deepflav_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvB=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB))
            output['deepflav_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvL=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB))
            ...
            output['deepcsv_CvBSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvBSF=sjets[:,0].btagDeepC/(1.-sjets[:,0].btagDeepB))
            output['deepcsv_CvLSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepcsv_CvLSF=sjets[:,0].btagDeepC/(sjets[:,0].btagDeepC+sjets[:,0].btagDeepB))
            output['deepflav_CvBSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvBSF=sjets[:,0].btagDeepFlavC/(1.-sjets[:,0].btagDeepFlavB))
            output['deepflav_CvLSF_0'].fill(dataset=dataset,flav=genflavor[:,0], deepflav_CvLSF=sjets[:,0].btagDeepFlavC/(sjets[:,0].btagDeepFlavC+sjets[:,0].btagDeepFlavB))
            ...
            output['deepcsv_CvBSF_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepcsv_CvBSF=sjets[:,1].btagDeepC/(1.-sjets[:,1].btagDeepB))
            output['deepcsv_CvLSF_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepcsv_CvLSF=sjets[:,1].btagDeepC/(sjets[:,1].btagDeepC+sjets[:,1].btagDeepB))
            output['deepflav_CvBSF_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepflav_CvBSF=sjets[:,1].btagDeepFlavC/(1.-sjets[:,1].btagDeepFlavB))
            output['deepflav_CvLSF_1'].fill(dataset=dataset,flav=genflavor[:,1],  deepflav_CvLSF=sjets[:,1].btagDeepFlavC/(sjets[:,1].btagDeepFlavC+sjets[:,1].btagDeepFlavB))
            ...
            output['deepcsv_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvBSF=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB))
            output['deepcsv_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepcsv_CvLSF=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB))
            output['deepflav_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvBSF=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB))
            output['deepflav_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2],  deepflav_CvLSF=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB))
            ...
            output['deepcsv_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvBSF=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB))
            output['deepcsv_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepcsv_CvLSF=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB))
            output['deepflav_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvBSF=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB))
            output['deepflav_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3],  deepflav_CvLSF=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB))
