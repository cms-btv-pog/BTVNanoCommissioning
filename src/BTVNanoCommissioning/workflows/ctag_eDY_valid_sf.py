...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        if isRealData :
            ...
            csvsfs_c[0]["SFup"] = getSF(ak.to_numpy(sjets[:,0].hadronFlavour),ak.to_numpy(sjets[:,0].btagDeepCvL),ak.to_numpy(sjets[:,0].btagDeepCvB),self._deepcsvc_sf,"TotalUncUp")
            csvsfs_c[0]["SFdn"] = getSF(ak.to_numpy(sjets[:,0].hadronFlavour),ak.to_numpy(sjets[:,0].btagDeepCvL),ak.to_numpy(sjets[:,0].btagDeepCvB),self._deepcsvc_sf,"TotalUncDown")
