...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        if isRealData :
            ...
            csvsfs_c_up_lj = getSF(ak.to_numpy(smuon_jet.hadronFlavour),ak.to_numpy(smuon_jet.btagDeepFlavC/(1.-smuon_jet.btagDeepFlavB)),ak.to_numpy(smuon_jet.btagDeepFlavC/(smuon_jet.btagDeepFlavC+smuon_jet.btagDeepFlavB)),deepcsvc_sf,"TotalUncUp")
            csvsfs_c_dn_lj = getSF(ak.to_numpy(smuon_jet.hadronFlavour),ak.to_numpy(smuon_jet.btagDeepFlavC/(1.-smuon_jet.btagDeepFlavB)),ak.to_numpy(smuon_jet.btagDeepFlavC/(smuon_jet.btagDeepFlavC+smuon_jet.btagDeepFlavB)),deepcsvc_sf,"TotalUncDown")
