    ...
    def process(self, events):
        ...
        if isRealData :
            ...
            if(all(i>1 for i in njet)):
                ...
                jetsfs_c_dn_sj = getSF(ak.to_numpy(sjets[:,1].hadronFlavour),ak.to_numpy(sjets[:,1].btagDeepC/(1.-sjets[:,1].btagDeepB)),ak.to_numpy(sjets[:,1].btagDeepC/(sjets[:,1].btagDeepC+sjets[:,1].btagDeepB)),deepjetc_sf,"TotalUncDown")
