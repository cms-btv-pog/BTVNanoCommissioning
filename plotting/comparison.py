...
parser.add_argument(
    ...
    "--phase",
    required=True,
    choices=["dilep", "ctag", "Wc", "DY", "ttsemilep", "ttdilep"],
    dest="phase",
...
for j in range(nj):
    for discr in arg.discr_list:
        ...
        if "mu" in discr and "njet" in discr:
            ...
            ax = plot.plot1d(
                hflav[arg.ref].sum("dataset"), error_opts=None, ax=ax, density=True
            )
            leg_label = []
            ...
            if arg.sepflav:
                ...
                ax = plot.plot1d(
                    hflav[arg.ref].sum("dataset").integrate("flav", slice(0, 4)),
                    ax=ax,
                    error_opts={
                        "linestyle": "none",
                        "marker": "o",
                ...
                plot.plot1d(
                    hflav[arg.ref].sum("dataset").integrate("flav", slice(4, 5)),
                    ax=ax,
                    error_opts={
                        "linestyle": "none",
                        "marker": "o",
                ...
                plot.plot1d(
                    hflav[arg.ref].sum("dataset").integrate("flav", slice(5, 6)),
                    ax=ax,
                    error_opts={
                        "linestyle": "none",
                        "marker": "o",
                ...
                ax = plot.plot1d(
                    hflav[arg.ref].sum("dataset").sum("flav"), ax=ax, density=True
                )
                leg_label = []
                ...
                for c in range(len(arg.compared[0])):
                    ...
                    plot.plot1d(
                        hflav[arg.compared[0][c]].sum("dataset").sum("flav"),
                        ax=ax,
                        clear=False,
                        density=True,
                    )
