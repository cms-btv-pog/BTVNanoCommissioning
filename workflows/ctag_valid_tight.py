...
class NanoProcessor(processor.ProcessorABC):
    ...
    def __init__(self):        
        ...
        npv_axis = hist.Bin("npv", r"numbers of primary vertices",40,0,80)
    ...
    def process(self, events):
        ...
        event_jet = events.Jet[(events.Jet.pt> 25) & (abs(events.Jet.eta) <= 2.4)&(events.Jet.puId > 5)&(events.Jet.jetId > 0)&(ak.all(events.Jet.metric_table(events.Muon) > 0.4, axis=2))]
        ...
        if not isRealData:
            ...
            output['btagDeepFlavB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavB=sjets[:,2].btagDeepFlavB,weight=weights.weight()[event_level])
            output['btagDeepFlavC_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavC=sjets[:,2].btagDeepFlavC,weight=weights.weight()[event_level])
            output['btagDeepB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepB=sjets[:,2].btagDeepB,weight=weights.weight()[event_level])
            output['btagDeepC_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepC=sjets[:,2].btagDeepC,weight=weights.weight()[event_level])
            output['deepcsv_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvB=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level])
            output['deepcsv_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvL=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level])
            output['deepflav_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvB=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level])
            output['deepflav_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvL=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level])
            output['btagDeepFlavB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavB=sjets[:,3].btagDeepFlavB,weight=weights.weight()[event_level])
            output['btagDeepFlavC_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavC=sjets[:,3].btagDeepFlavC,weight=weights.weight()[event_level])
            output['btagDeepB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepB=sjets[:,3].btagDeepB,weight=weights.weight()[event_level])
            output['btagDeepC_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepC=sjets[:,3].btagDeepC,weight=weights.weight()[event_level])
            output['deepcsv_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvB=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level])
            output['deepcsv_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvL=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level])
            output['deepflav_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvB=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level])
            output['deepflav_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvL=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level])
            ...
            output['btagDeepFlavBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavBSF=sjets[:,2].btagDeepFlavB,weight=(weights.weight()[event_level]*jetsfs_b_tj))      
            output['btagDeepFlavCSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavCSF=sjets[:,2].btagDeepFlavC,weight=weights.weight()[event_level]*jetsfs_c_tj)
            output['btagDeepBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepBSF=sjets[:,2].btagDeepB,weight=weights.weight()[event_level]*csvsfs_b_tj)
            output['btagDeepCSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepCSF=sjets[:,2].btagDeepC,weight=weights.weight()[event_level]*csvsfs_c_tj)
            output['deepcsv_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvBSF=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_tj)
            output['deepcsv_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvLSF=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_tj)
            output['deepflav_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvBSF=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_tj)
            output['deepflav_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvLSF=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_tj)
            output['btagDeepFlavBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavBSF=sjets[:,3].btagDeepFlavB,weight=(weights.weight()[event_level]*jetsfs_b_fj))      
            output['btagDeepFlavCSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavCSF=sjets[:,3].btagDeepFlavC,weight=weights.weight()[event_level]*jetsfs_c_fj)
            output['btagDeepBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepBSF=sjets[:,3].btagDeepB,weight=weights.weight()[event_level]*csvsfs_b_fj)
            output['btagDeepCSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepCSF=sjets[:,3].btagDeepC,weight=weights.weight()[event_level]*csvsfs_c_fj)
            output['deepcsv_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvBSF=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_fj)
            output['deepcsv_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvLSF=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_fj)
            output['deepflav_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvBSF=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_fj)
            output['deepflav_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvLSF=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_fj)
            ###SFs up
            ...
            output['btagDeepFlavB_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavB_up=sjets[:,2].btagDeepFlavB,weight=weights.weight()[event_level]*jetsfs_b_up_tj)
            output['btagDeepFlavC_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavC_up=sjets[:,2].btagDeepFlavC,weight=weights.weight()[event_level]*jetsfs_c_up_tj)
            output['btagDeepB_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepB_up=sjets[:,2].btagDeepB,weight=weights.weight()[event_level]*csvsfs_b_up_tj)
            output['btagDeepC_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepC_up=sjets[:,2].btagDeepC,weight=weights.weight()[event_level]*csvsfs_c_up_tj)
            output['deepcsv_CvB_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvB_up=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_tj)
            output['deepcsv_CvL_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvL_up=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_tj)
            output['deepflav_CvB_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvB_up=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_tj)
            output['deepflav_CvL_up_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvL_up=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_tj)
            output['btagDeepFlavB_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavB_up=sjets[:,3].btagDeepFlavB,weight=weights.weight()[event_level]*jetsfs_b_up_fj)
            output['btagDeepFlavC_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavC_up=sjets[:,3].btagDeepFlavC,weight=weights.weight()[event_level]*jetsfs_c_up_fj)
            output['btagDeepB_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepB_up=sjets[:,3].btagDeepB,weight=weights.weight()[event_level]*csvsfs_b_up_fj)
            output['btagDeepC_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepC_up=sjets[:,3].btagDeepC,weight=weights.weight()[event_level]*csvsfs_c_up_fj)
            output['deepcsv_CvB_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvB_up=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_fj)
            output['deepcsv_CvL_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvL_up=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_up_fj)
            output['deepflav_CvB_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvB_up=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_fj)
            output['deepflav_CvL_up_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvL_up=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_up_fj)            
            ###SFs down
            ...
            output['btagDeepFlavB_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavB_dn=sjets[:,2].btagDeepFlavB,weight=weights.weight()[event_level]*jetsfs_b_dn_tj)
            output['btagDeepFlavC_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavC_dn=sjets[:,2].btagDeepFlavC,weight=weights.weight()[event_level]*jetsfs_c_dn_tj)
            output['btagDeepB_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepB_dn=sjets[:,2].btagDeepB,weight=weights.weight()[event_level]*csvsfs_b_dn_tj)
            output['btagDeepC_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepC_dn=sjets[:,2].btagDeepC,weight=weights.weight()[event_level]*csvsfs_c_dn_tj)
            output['deepcsv_CvB_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvB_dn=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_tj)
            output['deepcsv_CvL_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvL_dn=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_tj)
            output['deepflav_CvB_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvB_dn=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_tj)
            output['deepflav_CvL_dn_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvL_dn=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_tj)
            output['btagDeepFlavB_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavB_dn=sjets[:,3].btagDeepFlavB,weight=weights.weight()[event_level]*jetsfs_b_dn_fj)
            output['btagDeepFlavC_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavC_dn=sjets[:,3].btagDeepFlavC,weight=weights.weight()[event_level]*jetsfs_c_dn_fj)
            output['btagDeepB_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepB_dn=sjets[:,3].btagDeepB,weight=weights.weight()[event_level]*csvsfs_b_dn_fj)
            output['btagDeepC_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepC_dn=sjets[:,3].btagDeepC,weight=weights.weight()[event_level]*csvsfs_c_dn_fj)
            output['deepcsv_CvB_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvB_dn=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_fj)
            output['deepcsv_CvL_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvL_dn=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB),weight=weights.weight()[event_level]*csvsfs_c_dn_fj)
            output['deepflav_CvB_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvB_dn=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_fj)
            output['deepflav_CvL_dn_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvL_dn=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB),weight=weights.weight()[event_level]*jetsfs_c_dn_fj)
        else:
            ...
            output['btagDeepFlavB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavB=sjets[:,2].btagDeepFlavB)
            output['btagDeepFlavC_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavC=sjets[:,2].btagDeepFlavC)
            output['btagDeepB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepB=sjets[:,2].btagDeepB)
            output['btagDeepC_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepC=sjets[:,2].btagDeepC)
            output['deepcsv_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvB=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB))
            output['deepcsv_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvL=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB))
            output['deepflav_CvB_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvB=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB))
            output['deepflav_CvL_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvL=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB))
            output['btagDeepFlavB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavB=sjets[:,3].btagDeepFlavB)
            output['btagDeepFlavC_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavC=sjets[:,3].btagDeepFlavC)
            output['btagDeepB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepB=sjets[:,3].btagDeepB)
            output['btagDeepC_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepC=sjets[:,3].btagDeepC)
            output['deepcsv_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvB=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB))
            output['deepcsv_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvL=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB))
            output['deepflav_CvB_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvB=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB))
            output['deepflav_CvL_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvL=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB))
            ...
            output['btagDeepFlavBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavBSF=sjets[:,2].btagDeepFlavB)
            output['btagDeepFlavCSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepFlavCSF=sjets[:,2].btagDeepFlavC)
            output['btagDeepBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepBSF=sjets[:,2].btagDeepB)
            output['btagDeepCSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, btagDeepCSF=sjets[:,2].btagDeepC)
            output['deepcsv_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvBSF=sjets[:,2].btagDeepC/(1.-sjets[:,2].btagDeepB))
            output['deepcsv_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepcsv_CvLSF=sjets[:,2].btagDeepC/(sjets[:,2].btagDeepC+sjets[:,2].btagDeepB))
            output['deepflav_CvBSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvBSF=sjets[:,2].btagDeepFlavC/(1.-sjets[:,2].btagDeepFlavB))
            output['deepflav_CvLSF_2'].fill(dataset=dataset,flav=genflavor[:,2], etawide=sjets[:,2].eta,ptwide=sjets[:,2].pt, deepflav_CvLSF=sjets[:,2].btagDeepFlavC/(sjets[:,2].btagDeepFlavC+sjets[:,2].btagDeepFlavB))
            output['btagDeepFlavBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavBSF=sjets[:,3].btagDeepFlavB)
            output['btagDeepFlavCSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepFlavCSF=sjets[:,3].btagDeepFlavC)
            output['btagDeepBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepBSF=sjets[:,3].btagDeepB)
            output['btagDeepCSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, btagDeepCSF=sjets[:,3].btagDeepC)
            output['deepcsv_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvBSF=sjets[:,3].btagDeepC/(1.-sjets[:,3].btagDeepB))
            output['deepcsv_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepcsv_CvLSF=sjets[:,3].btagDeepC/(sjets[:,3].btagDeepC+sjets[:,3].btagDeepB))
            output['deepflav_CvBSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvBSF=sjets[:,3].btagDeepFlavC/(1.-sjets[:,3].btagDeepFlavB))
            output['deepflav_CvLSF_3'].fill(dataset=dataset,flav=genflavor[:,3], etawide=sjets[:,3].eta,ptwide=sjets[:,3].pt, deepflav_CvLSF=sjets[:,3].btagDeepFlavC/(sjets[:,3].btagDeepFlavC+sjets[:,3].btagDeepFlavB))'''
