...
def btag_wp(jets, campaign, tagger, borc, wp):
    if "Summer22Run3" == campaign:
        # WP from https://btv-wiki.docs.cern.ch/ScaleFactors/Run3Summer22/
        WP = {
            "DeepFlav": {
                "b": {
                    "No": 0.0,
    ...
    # WP from https://btv-wiki.docs.cern.ch/ScaleFactors/Run3Summer22EE/
    elif "Summer22EERun3" == campaign:
        WP = {
            "DeepFlav": {
                "b": {
                    "No": 0,
    ...
    if borc == "b":
        ...
        jet_mask = (
            jets[f"btag{tagger}CvB"]
            > WP[tagger]["c"][wp][1] & jets[f"btag{tagger}CvL"]
            > WP[tagger]["c"][wp][0]
        )
    return jet_mask
