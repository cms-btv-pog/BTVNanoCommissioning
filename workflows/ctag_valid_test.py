...
class NanoProcessor(processor.ProcessorABC):
    ...
    def __init__(self):        
        ...
        jet_rawpt_axis   = hist.Bin("rawpt",   r"Jet $p_{T}$ [GeV]", 100, 0, 400)
        ...
        _hist_deepcsvSF_dict={
            'btagDeepBSF' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis, deepb_axis),
            'btagDeepCSF' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis,deepc_axis),
            'btagDeepFlavBSF' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis,deepjb_axis),
            'btagDeepFlavCSF' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis,deepjc_axis),
            'deepcsv_CvL' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis, deepcsv_CvL_axis),
            'deepcsv_BvC' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis, deepcsv_BvC_axis),
            'deepflav_CvL' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis, deepflav_CvL_axis),
            'deepflav_BvC' : hist.Hist("Counts", dataset_axis, flav_axis, jet_pt_axis,jet_eta_axis, deepflav_BvC_axis),
    ...
    def process(self, events):
        ...
        # print(ak.type(sjets.hadronFlavour),sjets.hadronFlavour)
        if not isRealData: stbjets = selev.Jet[(bjet_level)&(selev.Jet.hadronFlavour == 5)]
        if isRealData :
        ...
        if not isRealData:
            ...
            output['deepcsv_CvL'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepcsv_CvL=ak.flatten(sjets.btagDeepC/(1.-sjets.btagDeepB)),weight=csvsfs_c)
            output['deepcsv_BvC'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepcsv_BvC=ak.flatten(sjets.btagDeepC/(sjets.btagDeepC+sjets.btagDeepB)),weight=csvsfs_c)
            output['deepflav_CvL'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepflav_CvL=ak.flatten(sjets.btagDeepC/(sjets.btagDeepC+sjets.btagDeepB)),weight=jetsfs_c)
            output['deepflav_BvC'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepflav_BvC=ak.flatten(sjets.btagDeepC/(sjets.btagDeepC+sjets.btagDeepB)),weight=jetsfs_c)
            ###Fill SFs-nominal
            ...
            output['deepcsv_CvL'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepcsv_CvL=ak.flatten(sjets.btagDeepC/(1.-sjets.btagDeepB)))
            output['deepcsv_BvC'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepcsv_BvC=ak.flatten(sjets.btagDeepC/(sjets.btagDeepC+sjets.btagDeepB)))
            output['deepflav_CvL'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepflav_CvL=ak.flatten(sjets.btagDeepC/(sjets.btagDeepC+sjets.btagDeepB)))
            output['deepflav_BvC'].fill(dataset=dataset,flav=ak.flatten(genflavor), eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), deepflav_BvC=ak.flatten(sjets.btagDeepC/(sjets.btagDeepC+sjets.btagDeepB)))
            ###Fill SFs-nominal
            ...
            output['btagDeepFlavCSF'].fill(dataset=dataset,flav=0, eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), btagDeepFlavCSF=ak.flatten(sjets.btagDeepFlavC))
            ...
            output['btagDeepCSF'].fill(dataset=dataset,flav=0, eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), btagDeepCSF=ak.flatten(sjets.btagDeepC))
            ...
            output['btagDeepFlavCSF_up'].fill(dataset=dataset,flav=0, eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), btagDeepFlavCSF_up=ak.flatten(sjets.btagDeepFlavC))
            ...
            output['btagDeepCSF_up'].fill(dataset=dataset,flav=0, eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), btagDeepCSF_up=ak.flatten(sjets.btagDeepC))
            ...
            output['btagDeepFlavCSF_down'].fill(dataset=dataset,flav=0, eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), btagDeepFlavCSF_down=ak.flatten(sjets.btagDeepFlavC))
            ...
            output['btagDeepCSF_down'].fill(dataset=dataset,flav=0, eta=ak.flatten(sjets.eta),pt=ak.flatten(sjets.pt), btagDeepCSF_down=ak.flatten(sjets.btagDeepC))
