...
for j in range(nj):
    for discr in arg.discr_list:
        ...
        if 'mu'  in discr and 'njet' in discr :
            ...
            if arg.sepflav:
                ax=plot.plot1d(hflav[arg.compared[0]].sum("dataset").integrate("flav",slice(0,4)),ax=ax,error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'color':'b'},density=True)
                plot.plot1d(hflav[arg.compared[0]].sum("dataset").integrate("flav",slice(4,5)),ax=ax,error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'color':'g'},density=True,clear=False)
                plot.plot1d(hflav[arg.compared[0]].sum("dataset").integrate("flav",slice(5,6)),ax=ax,error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'color':'r'},density=True,clear=False)
                plot.plot1d(hflav[arg.ref].sum("dataset").integrate("flav",slice(0,4)),ax=ax,error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'mfc': 'none', 'elinewidth': 1.5,'color':'b'},density=True,clear=False)
                plot.plot1d(hflav[arg.ref].sum("dataset").integrate("flav",slice(4,5)),ax=ax,error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'mfc': 'none', 'elinewidth': 1.5,'color':'g'},density=True,clear=False)
                plot.plot1d(hflav[arg.ref].sum("dataset").integrate("flav",slice(5,6)),ax=ax,error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'mfc': 'none', 'elinewidth': 1.5,'color':'r'},density=True,clear=False)

                ax.legend(ncol=2,loc="upper right",handles=ax.get_legend_handles_labels()[0],labels=['mkfit-udsg','mkfit-c','mkfit-b','udsg','c','b'],fontsize=13)
                ...
                rax = plot.plotratio(
                                                ...
                                                ax=rax,
                                                error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'color':'b'},
                                                denom_fill_opts={},
                                                guide_opts={},
                                                unc='num',
                                                clear=False)
                rax2 = plot.plotratio(
                                                ...
                                                ax=rax2,
                                                error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'color':'g'},
                                                denom_fill_opts={},
                                                guide_opts={},
                                                unc='num',
                                                clear=False)
                rax3 = plot.plotratio(
                                                ...
                                                ax=rax3,
                                                error_opts={'linestyle': 'none','marker': 'o', 'markersize': 5.,'color':'r'},
                                                denom_fill_opts={},
                                                guide_opts={},
                                                unc='num',
                                                clear=False)
