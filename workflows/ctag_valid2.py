...
class NanoProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        selection.add('jetdr',(ak.all(event_jet.metric_table(event_muon) > 0.4, axis=2)))
        ...
        selection.add('jetpuid',event_jet.puId>0)
        ...
        selection.add('jetjetid',event_jet.jetId>0)
        ...
        regions={
            'nominal':['lumimask','trigger', 'musel', 'jetkin', 'jetdr', 'jetpuid', 'jetjetid','metsel'],
